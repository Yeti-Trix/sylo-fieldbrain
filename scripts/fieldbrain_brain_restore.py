#!/usr/bin/env python3
"""Restore a soft-deleted brain document (logicscout_brain_restore tool)."""
...
from services.brain_service import restore_brain
    ...
    emit(
        {
            "ok": True,
            "document": result,
            "operator_chat": f"Restored brain {args.scope}:{args.path}.",
        }
    )
